...
const shortQuestions = [
 {id:'worktype',multi:true,note:'Choose everything that applies. Most hair careers do not fit in one box.',title:'WHAT KIND OF HAIR WORK DO YOU DO?',choices:[['fullservice','I work behind the chair and do a little bit of everything.'],['color','I mainly do color.'],['cut','I mainly cut and style.'],['extensions','I specialize in extensions.'],['session','I do session, editorial, or commercial work.'],['events','I do bridal, events, or other on-location work.'],['education','I teach or work for a beauty brand.'],['owner','I own or manage a salon.'],['other','Something else.']]},
