...
const shortQuestions = [
 ...
 {id:'full',note:'Think about a normal week, not your busiest or quietest one.',title:'How much of your available appointment time gets booked?',choices:[['notyet','I’m not taking clients yet'],['under25','Most of my appointment times are still open'],['half','About half of my appointment times are booked'],['threequarters','Most of my appointment times are booked'],['full','Almost all of my appointment times are booked']]},
