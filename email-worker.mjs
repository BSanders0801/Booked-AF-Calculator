...
const shortQuestions = [
 {id:'goal',title:'What do you want help with most?',choices:[['clients','More clients in my chair'],['money','More money from the work I already do'],['return','More clients coming back'],['keep','Knowing where my money goes'],['time','A shorter work week'],['stable','More financial breathing room']]},
 {id:'full',title:'How full is your book most weeks?',choices:[['notyet','I’m not taking clients yet'],['under25','Less than a quarter full'],['half','About halfway full'],['threequarters','Mostly full'],['full','Packed, or close to it']]},
 {id:'days',title:'How many days a week do you work behind the chair?',choices:[['0','Not behind the chair yet'],['1','1 day'],['2','2 days'],['3','3 days'],['4','4 days'],['5','5 days'],['6','6–7 days']]},
 {id:'spend',title:'What does a typical client spend on services?',note:'A rough range is fine. This helps us understand your appointments, not judge your prices.',choices:[['notyet','I’m not taking clients yet'],['unknown','I’m not sure'],['75','Under $100'],['150','$100–$199'],['275','$200–$349'],['400','$350 or more']]},
 {id:'returning',title:'How often do your clients come back?',choices:[['notyet','Too early to know'],['low','Not many come back'],['some','Some do, some don’t'],['most','Most come back'],['almostall','Almost everyone comes back'],['unknown','I don’t know yet']]},
 {id:'costs',title:'After work costs, do you know how much money is left for you?',choices:[['clear','Yes, and I’m comfortable with it'],['tight','Yes, but it’s less than I need'],['rough','I have a rough idea'],['unknown','I don’t know yet']]},
 {id:'visibility',when:a=>a.goal==='clients',title:'Where do most new clients find you?',choices:[['social','Instagram or TikTok'],['salon','Through my salon'],['referrals','Friends, clients, or word of mouth'],['search','Google or my website'],['mix','A mix of places'],['none','I’m not getting new clients yet'],['unknown','I’m not sure']]},
 {id:'marketing',when:a=>a.goal==='clients',title:'What have you already tried to get clients?',choices:[['social','Posting my work online'],['people','Messaging people and asking for referrals'],['local','Meeting nearby businesses and people'],['paid','Paying for ads or promotions'],['mix','Several of these, without steady results'],['none','I haven’t found a starting point yet']]},
 {id:'network',when:a=>a.goal==='clients',title:'What could you put to work first?',choices:[['past','Past or happy clients I can contact'],['local','Local people or businesses I know'],['portfolio','Photos of work I want to do more of'],['models','A model service to build my portfolio'],['none','I’m starting from scratch']]},
 {id:'urgency',when:a=>a.goal==='clients',title:'How soon do you need more bookings?',choices:[['now','As soon as possible'],['month','Over the next month'],['steady','I have time to build steadily']]},
 {id:'nextvisit',when:a=>a.goal==='return',title:'What happens before a client leaves?',choices:[['prescribe','We discuss what they need next and when'],['ask','I ask if they want to book again'],['desk','The front desk handles the next appointment'],['rare','We usually don’t discuss the next visit']]},
 {id:'followup',when:a=>a.goal==='return',title:'If they leave without booking, what happens next?',choices:[['personal','I check in personally when their next visit is due'],['automatic','They get an automatic reminder'],['none','I usually wait for them to contact me'],['unknown','I’m not sure what happens']]},
 {id:'paymodel',when:a=>a.goal==='money'||a.goal==='keep',title:'How do you get paid?',choices:[['commission','The salon pays me a percentage'],['hourly','I get paid by the hour'],['self','I keep the service money and pay my own work costs'],['owner','I own the salon'],['mixed','A mix, or I’m not sure yet']]},
 {id:'servicehours',when:a=>a.goal==='money',title:'How long does a typical appointment take, including cleanup?',choices:[['short','Less than an hour'],['medium','About 1–2 hours'],['long','About 3–4 hours'],['verylong','5 hours or more'],['varies','It varies a lot'],['unknown','I don’t know yet']]},
 {id:'workcosts',when:a=>a.goal==='money',title:'Which work costs come out of your pocket?',choices:[['none','The salon covers my supplies and workspace'],['product','Mostly color, hair, or supplies'],['space','Mostly chair or suite rent'],['both','Rent plus color, hair, and supplies'],['team','Salon bills and team pay'],['unknown','I need to check']]},
 {id:'costleak',when:a=>a.goal==='keep',title:'Which work cost would you most like to understand?',choices:[['space','Commission, rent, or salon fees'],['product','Color, hair, and supplies'],['discount','Discounts, redos, or free extras'],['fees','Apps, fees, and smaller recurring bills'],['team','Team pay and salon bills'],['unknown','I don’t know where to start']]},
 {id:'weeklyhours',when:a=>a.goal==='time',title:'About how many hours does work take each week?',note:'Include clients, cleanup, messages, and other work you do outside appointments.',choices:[['under20','Under 20 hours'],['20to30','20–30 hours'],['31to40','31–40 hours'],['over40','More than 40 hours'],['unknown','I’m not sure']]},
 {id:'targetdays',when:a=>a.goal==='time',title:'How many days would you like to work?',choices:[['1','1 day'],['2','2 days'],['3','3 days'],['4','4 days'],['5','5 days'],['shorter','The same days, with shorter hours'],['unknown','I want help figuring that out']]},
 {id:'overrun',when:a=>a.goal==='time',title:'What takes the most extra time?',choices:[['gaps','Empty gaps between appointments'],['overrun','Appointments running late'],['squeeze','Extra clients I squeeze in'],['messages','Messages, admin, and work outside the salon'],['none','There isn’t much wasted time'],['unknown','I’m not sure yet']]},
 {id:'savings',when:a=>a.goal==='stable',title:'If work slowed down, how long could your savings cover the basics?',choices:[['none','I don’t have savings for that yet'],['month','About a month'],['few','A few months'],['solid','Six months or more'],['unknown','I’m not sure']]},
 {id:'futurehabit',when:a=>a.goal==='stable',title:'What usually gets in the way of saving?',choices:[['catchup','Bills use up what I make'],['spend','Extra money disappears into everyday spending'],['random','My pay changes, and I don’t have a routine'],['save','I’m saving regularly already']]},
 {id:'futurefear',when:a=>a.goal==='stable',title:'What would make you feel more secure first?',choices:[['emergency','Money for a slow month or an emergency'],['timeoff','Being able to take time off'],['retire','Saving for later in life'],['body','Not depending on my body for every dollar'],['unknown','I need help choosing where to start']]}
];
