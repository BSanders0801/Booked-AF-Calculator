...
const shortQuestions = [
 ...
 {id:'hourlytime',when:a=>a.goal==='money'&&a.paymodel==='hourly',title:"ARE YOU DOING WORK THAT DOESN’T SHOW UP AS PAID TIME?",choices:[["no", "No. My paid hours match the time I’m working."], ["sometimes", "Sometimes. Messages, setup, cleanup, or other work happens off the clock."], ["often", "Yes. More than I’d like."], ["unknown", "I need to compare my hours with my payslip."]]},
 {id:'spend',when:a=>a.goal==='money'&&a.paymodel!=='hourly',title:"WHAT DOES A CLIENT USUALLY SPEND IN YOUR CHAIR?",note:"Just the hair services. Leave out tips and take-home products. Pick the closest amount.",choices:[["notyet", "I’m not taking clients yet."], ["unknown", "Honestly? I need to check."], ["75", "Under $100"], ["150", "$100-$199"], ["275", "$200-$349"], ["400", "$350 or more"]]},
 {id:'returning',when:a=>a.goal==='clients'||a.goal==='return',title:"THEY CAME IN. ARE THEY COMING BACK?",choices:[["notyet", "I’m still getting started. Too soon to tell."], ["low", "Not many come back. I’d like to change that."], ["some", "Some come back. Some I never see again."], ["most", "Most come back for more."], ["almostall", "Almost everyone comes back."], ["unknown", "I haven’t kept track."]]},
 {id:'costs',when:a=>a.goal==='keep'||(a.goal==='money'&&a.paymodel!=='hourly'),note:'After the salon’s share and any rent or supplies you pay for. Before personal bills and taxes.',title:'YOU DID THE HAIR. HOW MUCH OF THE MONEY IS ACTUALLY YOURS?',choices:[['clear','I know what I keep, and it’s enough.'],['tight','I know what I keep. It needs to be more.'],['rough','I have a ballpark idea.'],['unknown','Honestly? I need help figuring that out.']]},
 {id:'visibility',when:a=>a.goal==='clients',multi:true,exclusive:['none','unknown'],note:"Choose all that are actually bringing you new clients.",title:"HOW ARE NEW CLIENTS FINDING YOUR CHAIR?",choices:[["social", "Instagram or TikTok."], ["salon", "The salon sends them my way."], ["referrals", "Referrals or word of mouth."], ["search", "Google or my website."], ["none", "New clients aren’t finding me yet."], ["unknown", "Good question. I need to start asking."]]},
 {id:'marketing',when:a=>a.goal==='clients',multi:true,exclusive:['none'],note:"Choose all that apply.",title:"WHAT HAVE YOU TRIED TO GET PEOPLE IN YOUR CHAIR?",choices:[["social", "Posting my work online."], ["people", "Asking people I know to send clients my way."], ["local", "Introducing myself to people and businesses nearby."], ["paid", "Paying for ads or promotions."], ["none", "I haven’t started yet. I need a first move."]]},
